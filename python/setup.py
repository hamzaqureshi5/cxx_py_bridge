...
FFI_MODE = os.environ.get("FFI_FFI", "auto")
...
setup(
    name="ffi",
    # version=__version__,
    description="FFI: An End to End Tensor IR/DSL Stack for Deep Learning Systems",
    long_description="long_description_contents()",
    long_description_content_type="text/markdown",
    url="https://tvm.apache.org/",
    download_url="https://github.com/open-etsi/ffi",
    author="FFI",
    license="Apache",
